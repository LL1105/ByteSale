CREATE
DATABASE IF NOT EXISTS byte_sale_payment_0 CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE
byte_sale_payment_0;

DROP TABLE IF EXISTS pay_bill_0;
CREATE TABLE `pay_bill_0`
(
...
DROP TABLE IF EXISTS refund_bill_0;
CREATE TABLE `refund_bill_0`
(
    `id`            bigint(20) NOT NULL COMMENT '主键id',
    `out_order_no`  varchar(64)    NOT NULL COMMENT '商户订单号',
...
DROP TABLE IF EXISTS pay_bill_1;
CREATE TABLE `pay_bill_1`
(
    `id`              bigint(20) NOT NULL COMMENT '主键id',
    `pay_number`      varchar(64)  DEFAULT NULL COMMENT '支付流水号',
    `out_order_no`    varchar(64)    NOT NULL COMMENT '商户订单号',
...
DROP TABLE IF EXISTS refund_bill_1;
CREATE TABLE `refund_bill_1`
(
    `id`            bigint(20) NOT NULL COMMENT '主键id',
    `out_order_no`  varchar(64)    NOT NULL COMMENT '商户订单号',
    `pay_bill_id`   bigint(20) NOT NULL COMMENT '账单id',
...
CREATE
DATABASE IF NOT EXISTS byte_sale_payment_1 CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE
byte_sale_payment_1;
